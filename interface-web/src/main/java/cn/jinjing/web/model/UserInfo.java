...
public class UserInfo {
    ...
    public String getAttenTelephone() {
        return attenTelephone;
    }

    public void setAttenTelephone(String attenTelephone) {
        this.attenTelephone = attenTelephone == null ? null : attenTelephone.trim();
    }
    ...
    public void setAttenEmail(String attenEmail) {
        this.attenEmail = attenEmail == null ? null : attenEmail.trim();
    }
