...
public class Config {
    ...
    public static void loadingStdConfig(String[] args, String defaultConfig) throws Exception {
        ...
        if (hasArg("-lc") && hasArgValue("-lc")) {
            ...
            if (path.toLowerCase().endsWith(".properties")) {
                ...
                PropertyConfigurator.configure(Config.class.getClassLoader().getResource("global.log4j.properties"));
    ...
    public static void loadClasspathConfig(String classPathConfig) throws Exception {
        InputStreamReader is = new InputStreamReader(Config.class.getClassLoader().getResourceAsStream(classPathConfig), "UTF-8");
        if (null == is) {
